...
class StudentHandler {
    ...
    public static function addStudent ($class, $studentName, $studentNumber) {
        if ($class && $studentName && $studentNumber) {
            ...
            //Afternoon periods
            $afternoonPeriod1S = mktime(18,30,00);
            $afternoonPeriod1F = mktime(18,30,00);

            $afternoonPeriod2S = mktime(18,30,00);
            $afternoonPeriod2F = mktime(18,30,00);

            $afternoonPeriod3S = mktime(18,30,00);
            $afternoonPeriod3F = mktime(18,30,00);

            $afternoonPeriod4S = mktime(18,30,00);
            $afternoonPeriod4F = mktime(18,30,00);

            $afternoonPeriod5S = mktime(18,30,00);
            $afternoonPeriod5F = mktime(18,30,00);
